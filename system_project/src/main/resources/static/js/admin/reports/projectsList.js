...
async function loadProjects(resetTable = false) {
    ...
    try {
        ...
        const response = await fetch(`/input/admin/projects/page?page=${currentPage}&size=${pageSize}&filter=${encodeURIComponent(filter)}`);
        ...
        data.content.forEach(project => {
            ...
            row.innerHTML = `
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectId}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectName}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectContractualAcronym.acronym}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectBusinessVerticalLabel}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectPriorityLabel}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectStatusLabel}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${project.projectExecutionPercentage}%</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${startDate}</a>
                </td>
                <td class="text-left">
                    <a href="/input/admin/projects/edit/${project.projectId}" class="row-link">${endDate}</a>
                </td>
            `;
