...
async function loadOccupations(resetTable = false) {
    ...
    try {
        ...
        data.content.forEach(occupation => {
            ...
            row.innerHTML = `
                <td class="text-left">
                    <a href="/input/user/reports/editOccupation/${occupation.occupationId}" class="row-link">${occupation.occupationId}</a>
                </td>
                <td class="text-left">
                    <a href="/input/user/reports/editOccupation/${occupation.occupationId}" class="row-link">${occupation.occupationName}</a>
                </td>
                <td class="text-left">
