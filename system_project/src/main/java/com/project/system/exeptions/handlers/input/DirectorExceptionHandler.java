...
import com.project.system.controller.input.DirectorController;

import java.util.HashMap;
import java.util.Map;

@ControllerAdvice(assignableTypes = DirectorController.class)
public class DirectorExceptionHandler {
	...
	public Object handleAccessDeniedException(HttpServletRequest request, AccessDeniedException ex) {
	    ...
	    if (uri.contains("/input/director/removeUser")) {
	        response.put("mensagem", "Você não tem permissão para excluir usuários.");
	    } 
	    else if (uri.contains("/input/director/users/edit")) {
	        response.put("mensagem", "Você não tem permissão para editar usuários.");
	    } 
	    else if (uri.contains("/input/director/users/save")) {
    ...
    public ResponseEntity<Map<String, String>> handleAllExceptions(HttpServletRequest request, Exception ex) {
        ...
        if (request.getRequestURI().contains("/input/director/users/save")) {
